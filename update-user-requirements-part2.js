...
async function updateFinance(classCode) {
...
async function main() {
  console.log('=== STARTING USER REQUIREMENT UPDATES PART 2 ===');

  // 1. lớp M3 Ms My - T2 & T4 (CN1_M3_MsMy_24_01): tất cả Học viên đã đóng học phí, lớp đã học tới buổi 8.
  await updateFinance('CN1_M3_MsMy_24_01');
  await setSessions('CN1_M3_MsMy_24_01', 8);

  // 2. lớp S1 Ms My - T7 & CN (CN1_S1_MsMy_7CN_Ca4): lớp đã học tới buổi 8.
  await setSessions('CN1_S1_MsMy_7CN_Ca4', 8);

  // 3. lớp S3 Ms My - T3 & T5 (CN1_S3_MsMy_35_Ca2): lớp đã học tới buổi 8.
  await setSessions('CN1_S3_MsMy_35_Ca2', 8);
